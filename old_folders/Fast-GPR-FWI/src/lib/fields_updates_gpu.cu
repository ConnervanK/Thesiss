...
__global__ void e_fields_updates_gpu(
   ...
   __declspec(dllexport) void e_fields_updates(float *uE0, float *uE1,float *Ex,float *Ey,float *Ez,float *Hx,float *Hy,float *Hz,int step, int NX_FIELDS, int NY_FIELDS, int NZ_FIELDS) {
...
__global__ void h_fields_updates_gpu(
   ...
   __declspec(dllexport) void h_fields_updates(float *uH0, float *uH1, float *Ex,float *Ey,float *Ez,float *Hx,float *Hy,float *Hz, int step, int NX_FIELDS, int NY_FIELDS, int NZ_FIELDS) {
