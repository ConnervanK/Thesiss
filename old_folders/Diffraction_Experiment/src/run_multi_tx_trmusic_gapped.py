...
def main():
    ...
    if not args.skip_sim:
        ...
        for i, tx_x in enumerate(tx_positions, start=1):
            idx = f"{i:02d}"
            alt_in = in_alt_dir / f"gapped_scattering_tx{idx}.in"
        ...
        for i in range(1, n_tx + 1):
            ...
            alt_out_dst = out_dir / f"gapped_scattering_tx{idx}.out"
    ...
    tx_glob = str((out_dir / "gapped_scattering_tx*.out").as_posix())
