...
from old_folders.TimeLapse_Experiment.src.utils.processing import apply_svd_filter, calculate_cross_correlation, envelope, kirchhoff_migration, compute_cwt_image
