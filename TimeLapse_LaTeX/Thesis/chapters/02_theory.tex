...
This chapter develops the theory used throughout the thesis, in two parts.
\Cref{sec:th-migration} reviews the three migration algorithms used to focus
the raw GPR data (\cref{ch:resolution,ch:tl-horizontal,ch:tl-vertical,ch:fluidflow}).
