...
\paragraph{Hypothesis.} The phase-plane shift estimator --- together with its
local, time-frequency analogues (instantaneous phase imaging, spectral-line
fitting, cross-phase spectrograms, and localised-STFT phase decomposition)
--- remains accurate at the lateral and vertical displacement scales where
\cref{ch:tl-horizontal,ch:tl-vertical} showed the amplitude image is already
featureless, and all of these independent analyses agree with each other.
