...
__global__ void ucget(float *er,float *se,float *mr,float *uE0, float *uE1, float *uE4,float *uH0, float *uH1, float *uH4,int NX_FIELDS, int NY_FIELDS, int NZ_FIELDS,float dt,float dx) {
   ...
   __declspec(dllexport) void Ucget(float *er,float *se,float *mr,float *uE0, float *uE1, float *uE4,float *uH0, float *uH1, float *uH4,int NX_FIELDS, int NY_FIELDS, int NZ_FIELDS,float dt,float dx) {
...
//             float EB = (e0 * er[INDEX3D_FIELDS(i, j, k,NY_FIELDS,NZ_FIELDS)] / dt) - 0.5 * se[INDEX3D_FIELDS(i, j, k,NY_FIELDS,NZ_FIELDS)];
   ...
   __declspec(dllexport) void Ucgeta(float *er,float *se,float *mr,float *uE0, float *uE1, float *uE4,float *uH0, float *uH1, float *uH4,int NX_FIELDS, int NY_FIELDS, int NZ_FIELDS,float dt,float dx) {
