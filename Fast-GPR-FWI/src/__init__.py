...
so_files = ['back.dll', 'fields_updates_gpu.dll','sourcereceiver.dll', 'uc.dll', 'pml_updates_h.dll', 'pml_updates_e.dll']
...
lib_path = os.path.join(os.path.dirname(__file__), 'lib', 'fields_updates_gpu.dll')
libsr_path = os.path.join(os.path.dirname(__file__), 'lib', 'sourcereceiver.dll')
libuc_path = os.path.join(os.path.dirname(__file__), 'lib', 'uc.dll')
libph_path= os.path.join(os.path.dirname(__file__), 'lib', 'pml_updates_h.dll')
libpe_path = os.path.join(os.path.dirname(__file__), 'lib', 'pml_updates_e.dll')
libback_path=os.path.join(os.path.dirname(__file__), 'lib', 'back.dll')
